...
| [AtCoder Beginner Contest 435 - problem_B](https://atcoder.jp/contests/abc435/tasks/abc435_b) | [atcoder8.ipynb - my_answer](https://github.com/iamthinking98-jpg/AtCoder/blob/main/atcoder8.ipynb) |The previous implementation calculated sum(A[i:j+1]) from scratch in every iteration.
I refactored the logic to update the total sum incrementally. This approach avoids unnecessary list copying and improves execution speed within the $O(N^3)$ constraints.|
