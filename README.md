...
| [AtCoder Beginner Contest 428 - problem_B](https://atcoder.jp/contests/abc428/tasks/abc428_b) | [atcoder1.ipynb - my_answer](https://github.com/iamthinking98-jpg/AtCoder/blob/main/atcoder2.ipynb) | Using **collections.Counter** for efficient frequency counting, and **list comprehension** for concise list creation.|
